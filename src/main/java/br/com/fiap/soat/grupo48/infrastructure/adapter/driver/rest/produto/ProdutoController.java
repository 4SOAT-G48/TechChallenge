...
public class ProdutoController {
  ...
  public ResponseEntity<Page<ProdutoResponse>> getProdutosPaginados(
    ...
    Page<ProdutoResponse> listResponse = this.produtoDTOMapper.toListResponse(produtos);
    return new ResponseEntity<>(listResponse, HttpStatus.OK);
  }
  ...
  public ResponseEntity<?> updateProduto(@PathVariable final UUID codigo, @RequestBody final ProdutoRequest request) {
